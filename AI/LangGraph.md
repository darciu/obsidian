...
W funkcjach użytych jako nodes LLM czyta też docstring, więc należy podawać tam sensowne opisy. 
...
TypedDict podpowiada typy w IDE (zwykły dictionary), a Pydantic plinuje typów danych, także podczas działania programu (walidacja w locie). Pydantic jest z tego powodu małym obciążeniem.
